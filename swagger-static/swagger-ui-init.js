          ...
          get: {
            ...
            parameters: [
              ...
              },
              {
                ...
                in: 'query',
                schema: {
                  enum: ['Administrator', 'Manager', 'Educator', 'Client'],
                  type: 'string',
                },
              },
            ],
        ...
        '/v1/dogs/{dogId}': {
          get: {
            ...
            responses: {
              ...
              401: {
                description:
                  'Unauthorized if the **Client** is not the owner of the dog',
              },
              404: {
        ...
        '/v1/observations': {
          post: {
            ...
            responses: {
              ...
              401: {
                description:
                  '**Client** not allowed to create a dog observation',
              },
              422: {
                description: 'Unprocessable Entity',
              },
        ...
        '/v1/observations/{observationId}': {
          ...
          put: {
            ...
            responses: {
              ...
              401: {
                description:
                  '**Client** not allowed to modify a dog observation',
              },
              404: {
        ...
        '/v1/holidays': {
          ...
          get: {
            ...
            responses: {
              ...
              401: {
                description:
                  '**Clients** not allowed to find all employee holidays',
              },
            },
            tags: ['holidays'],
            security: [
        ...
        '/v1/holidays/{holidayId}': {
          get: {
            ...
            responses: {
              ...
              401: {
                description:
                  '**Clients** not allowed to find an employee holiday',
              },
              404: {
        ...
        schemas: {
          CreateSessionDto: {
            ...
            properties: {
              ...
              status: {
                type: 'string',
                enum: ['Canceled', 'Online', 'Pending', 'Postponed'],
                default: 'Pending',
              },
              maximumCapacity: {
                type: 'number',
          ...
          User: {
            ...
            properties: {
              ...
              role: {
                type: 'string',
                enum: ['Administrator', 'Manager', 'Educator', 'Client'],
                examples: ['Administrator', 'Manager', 'Educator', 'Client'],
                default: 'Client',
              },
              emailAddress: {
                type: 'string',
          ...
          CreateReservationDto: {
            ...
            required: ['activity', 'establishment', 'dogs', 'isApproved'],
          },
          Reservation: {
            type: 'object',
            properties: {
          ...
          Observation: {
            ...
            properties: {
              ...
              createdAt: {
                format: 'date-time',
                type: 'string',
                default: '2023-09-25T07:28:04.891Z',
              },
              __v: {
                type: 'number',
              },
            },
            required: ['_id', 'dog', 'description', 'createdAt', '__v'],
          },
