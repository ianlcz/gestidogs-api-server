        ...
        '/payments': {
          post: {
            ...
            responses: {
              ...
              401: {
                description:
                  'Unauthorized because only **Client** can create a Payment',
              },
              502: {
                description: 'Bad Request',
              },
        ...
        schemas: {
          CreateSessionDto: {
            ...
            properties: {
              ...
              status: {
                type: 'string',
                enum: ['Online', 'Pending', 'Postponed', 'Canceled'],
                default: 'Pending',
              },
              maximumCapacity: {
                type: 'number',
          ...
          Establishment: {
            ...
            required: ['owner', 'name', 'address', 'schedules'],
          },
          Activity: {
            type: 'object',
            properties: {
            ...
            required: ['establishment', 'title', 'duration', 'price'],
          },
          User: {
            type: 'object',
            properties: {
          ...
          UpdateUserDto: {
            ...
            required: ['lastname', 'firstname', 'emailAddress', 'password'],
          },
          CreateEstablishmentDto: {
            ...
            required: ['owner', 'name', 'address', 'emailAddress', 'schedules'],
          },
